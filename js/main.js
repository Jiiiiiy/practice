$(function() {
  ...
  for(let i=1;i<=vli;i++) {
    ...
    $('.visual_wrap button:nth-child(' + i + ')').click(function() {
      $('.visual_wrap ul li:nth-child(' + i + ')').fadeIn()
    })
  ...
  setInterval(function() { //visual_wrap : 이미지 무한 반복
    $('.visual_wrap .btns button:first-child').addClass('on').next().end(4000)
  ...
  // $('.visual_wrap .btns').append('<button class="on"><span class="blind">' + i + '번째' + '</span></button>')

  
  
  function mobileImg() {
    $('.v2 img').attr('src','img/visual_01_m.jpg')
  }
  function pcImg() {
